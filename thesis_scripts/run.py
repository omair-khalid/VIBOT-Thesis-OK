#!/usr/bin/env python
# -*- coding: utf-8 -*-
# Original Author: Olexa Bilaniuk
# Adapted by: Omair Khalid, for Masters Thesis Experimentation
...
class Train(Subcommand):
	...
	def addArgs(cls, argp):
		...
		argp.add_argument("--dataset",              default="cifar10",          type=str,#===========================================DATASET
		    help="Dataset Selection.")
		argp.add_argument("--dropout",              default=0,                  type=float,
		    help="Dropout probability.")
		argp.add_argument("-n", "--num-epochs",     default=200,                type=int,#============================================NO OF EPOCHS
		    help="Number of epochs")
		argp.add_argument("-b", "--batch-size",     default=64,                 type=int,
		    help="Batch Size")
		argp.add_argument("--start-filter", "--sf", default=12,                 type=int,#==========NO OF START FILTERS
		...
		argp.add_argument("--act",                  default="relu",             type=str,
		    choices=["relu"],
		    help="Activation.")
		argp.add_argument("--aact",                 default="modrelu",          type=str,#=======================================AACT
		    choices=["modrelu"],
		    help="Advanced Activation.")
		argp.add_argument("--no-validation", action="store_true",
		    help="Do not create a separate validation set.")
		argp.add_argument("--comp_init",            default='complex_independent',  type=str,#=======================COMPLEX INDEPENDENT INITIALIZER
